...
BMAD_SOURCE="$SCRIPT_DIR/claude/skills"
if [ ! -d "$BMAD_SOURCE" ] && [ -d "$SCRIPT_DIR/skills" ]; then
...
if [ -d "$BMAD_SOURCE" ]; then
  ...
  echo "Warning: BMAD skill source not found. Expected claude/skills or skills beside setup.sh."
fi
